...
def search(x_train, y_train, out_dim, Loss_type='CE', hidden_size_choices = list(range(10,1000,10)), flops_balance_factor = 0.2, net_weight_lr = 0.0001, arch_lr = 0.01, num_epochs = 10000, search_freq = 20):
...
# Initialize the neural network
def search_CS_LS(x_train, y_train, out_dim, Loss_type='CE', hidden_size_choices = list(range(10,1000,10)),layer_choices = [1,2,3], flops_balance_factor = 0.2, net_weight_lr = 0.0001, arch_lr = 0.01, num_epochs = 10000, search_freq = 20):
    # out_dim: The ouput dimension of the network. It should be the number of classes for 'CE' loss
    # Loss_type: should be either 'CE' or 'MSE'
    # hidden_size_choices: The choices for the number of hidden units.
    # flops_balance_factor: The factor to balance performance (CE Loss or MSE Loss) and FLOPs. 
    ...
    net = SuperNet_CS_LS(in_dim, hidden_size_choices, layer_choices, out_dim)
